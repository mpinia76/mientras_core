 ...
 */
class TipoProducto extends \Mientras\Core\model\TipoProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mientras\\Core\\model\\TipoProducto' . "\0" . 'nombre', '' . "\0" . 'Mientras\\Core\\model\\TipoProducto' . "\0" . 'servicioTecnico'];
        }
    ...
    public function getServicioTecnico()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getServicioTecnico', []);

        return parent::getServicioTecnico();
    }
    ...
    public function setServicioTecnico($servicioTecnico)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setServicioTecnico', [$servicioTecnico]);

        return parent::setServicioTecnico($servicioTecnico);
    }
