...
class Venta extends \Mientras\Core\model\Venta implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mientras\\Core\\model\\Venta' . "\0" . 'fecha', '' . "\0" . 'Mientras\\Core\\model\\Venta' . "\0" . 'cliente', '' . "\0" . 'Mientras\\Core\\model\\Venta' . "\0" . 'monto', '' . "\0" . 'Mientras\\Core\\model\\Venta' . "\0" . 'montoPagado', '' . "\0" . 'Mientras\\Core\\model\\Venta' . "\0" . 'montoDebe', '' . "\0" . 'Mientras\\Core\\model\\Venta' . "\0" . 'estado', '' . "\0" . 'Mientras\\Core\\model\\Venta' . "\0" . 'observaciones', '' . "\0" . 'Mientras\\Core\\model\\Venta' . "\0" . 'user', '' . "\0" . 'Mientras\\Core\\model\\Venta' . "\0" . 'detalles'];
        }
