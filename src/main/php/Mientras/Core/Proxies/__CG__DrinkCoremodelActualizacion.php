 ...
 */
class Actualizacion extends \Mientras\Core\model\Actualizacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mientras\\Core\\model\\Actualizacion' . "\0" . 'fechaHora', '' . "\0" . 'Mientras\\Core\\model\\Actualizacion' . "\0" . 'cliente', '' . "\0" . 'Mientras\\Core\\model\\Actualizacion' . "\0" . 'monto', '' . "\0" . 'Mientras\\Core\\model\\Actualizacion' . "\0" . 'observaciones', '' . "\0" . 'Mientras\\Core\\model\\Actualizacion' . "\0" . 'user'];
        }
