 ...
 */
class Pago extends \Mientras\Core\model\Pago implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mientras\\Core\\model\\Pago' . "\0" . 'fechaHora', '' . "\0" . 'Mientras\\Core\\model\\Pago' . "\0" . 'cliente', '' . "\0" . 'Mientras\\Core\\model\\Pago' . "\0" . 'monto', '' . "\0" . 'Mientras\\Core\\model\\Pago' . "\0" . 'estado', '' . "\0" . 'Mientras\\Core\\model\\Pago' . "\0" . 'observaciones', '' . "\0" . 'Mientras\\Core\\model\\Pago' . "\0" . 'user'];
        }
