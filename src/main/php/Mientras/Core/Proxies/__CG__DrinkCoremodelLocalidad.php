 ...
 */
class Localidad extends \Mientras\Core\model\Localidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mientras\\Core\\model\\Localidad' . "\0" . 'nombre', '' . "\0" . 'Mientras\\Core\\model\\Localidad' . "\0" . 'provincia'];
        }
