 ...
 */
class ConceptoGasto extends \Mientras\Core\model\ConceptoGasto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mientras\\Core\\model\\ConceptoGasto' . "\0" . 'nombre'];
        }
